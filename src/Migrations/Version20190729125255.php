 ...
 */
final class Version20190729125255 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD gender VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE users ADD firstname VARCHAR(255) DEFAULT NULL');
