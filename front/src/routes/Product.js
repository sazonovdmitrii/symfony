...
export default class Product extends Component {
    ...
    render() {
        const { items, name, images, brand_name, comments, likes, name_translit, vendor_code } = this.props;
                    ...
                    <div className="product__options">
                        ...
                        <div>
                            ...
                            <div className="product-element__textlist rte">
                                <RichText>
                                    <p>
                                        Раскрыть свою неповторимость, почувствовать прилив невероятной энергии
                                        в любое время года легко, если у вас имеется туалетная вода In Red
                                        ...
                                        авангардизма и традиций классики модного дома, который хочется
                                        заказать, чтобы познакомиться с ним. Индивидуальность, внутренняя
                                        сила, уверенность — вот главные качества обладательницы In Red.
                                        Верхние ноты являют собой сплетение пикантного кардамона, сочного
                                        бергамота, пряного имбиря и чуть горьковатого мандарина. Сердце
                                        аромата полностью и без остатка принадлежит цветочному ансамблю из
                                        весеннего ландыша, фиалки, очаровательного жасмина и благоухающей
                                        розы. Это нежное соцветие переходит в древесное послевкусие из нот
                                        мускуса и мха. Доступная цена In Red от
                                        <strong> Armand Basi</strong> в сочетании с затейливым дизайном
                                        флакона привлекает к себе внимание уже больше 10 лет. Потому аромат
                                        заслуживает самых лучших отзывов со стороны покупательниц. Испанская
                                        страсть парфюмерной композиции In Red заряжает положительными эмоциями
                                        каждый день. Вдохнув однажды запах туалетной воды от
                        ...
                        <div className="small_catalog">
                            <div className="catalog carousel-4o2s163">
                                <div className="catalog__item">
                                    <a href="/armand-basi-nabor-in-red2.htm" className="catalog__item_link">
